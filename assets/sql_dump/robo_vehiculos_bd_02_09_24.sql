...
INSERT INTO `dueños` VALUES (1,'','quien','','2024-08-20 06:00:00',1),(2,'joaquina','Perez','Ayala','2015-11-15 06:00:00',0),(3,'Q','p','s','2024-08-20 06:00:00',0),(5,'Sonrisas','Bien','Bromas','2024-08-20 06:00:00',0),(6,'Arturo','Duran','Lopez','2022-10-10 06:00:00',0),(7,'Alejandro','Jazo','Jazo2','2024-08-27 23:40:42',1),(8,'Biometricos','a','Doble','2024-08-27 23:46:20',1),(9,'','','','2024-08-28 00:12:00',1),(10,'','','','2024-08-28 01:39:41',1),(11,'','','','2024-08-28 01:53:07',1),(12,'','','','2024-08-28 01:54:23',1),(13,'Arturo200','311','311111','2024-08-28 02:20:54',1),(14,'Arthur','00000000000','311111','2024-08-28 02:46:33',0),(15,'Biometricos','pueda','Doble','2024-08-28 03:12:09',0),(16,'Atension SRE 3','pueda','Doble','2024-08-29 01:35:42',1),(17,'Hidalgo','Montiel','Garcia','2024-08-29 01:54:49',1),(18,'Manantial','dela','valle','2024-08-30 11:32:26',1),(19,'dsa','sad','da','2024-08-30 11:34:52',1);
...
INSERT INTO `placas` VALUES (1,'1234','2021-12-12 06:00:00',0,19),(2,'Placa2','2024-08-20 06:00:00',0,22),(4,'Placa3','2024-08-20 06:00:00',0,22),(5,'99999','2020-10-10 06:00:00',0,NULL),(6,'Placa4','2024-08-27 06:00:00',1,NULL),(7,'12345','2024-08-28 21:16:11',1,NULL),(8,'8888','2024-08-30 10:37:43',1,NULL),(9,'Mazatlan','2024-08-30 21:19:28',0,14),(10,'pl101','2024-08-30 23:24:51',0,NULL),(11,'pl102','2024-08-30 23:24:55',0,20),(12,'pl103','2024-08-30 23:24:59',0,NULL),(13,'pl104','2024-08-30 23:25:03',0,NULL),(14,'pl105','2024-08-30 23:25:07',0,NULL);
...
CREATE TABLE `propietario` (
  ...
  KEY `propietario_dueÃ±os_FK` (`duenos_id`),
...
CREATE TABLE `robos` (
  ...
  KEY `robos_dueÃ±os_FK` (`duenos_id`),
  CONSTRAINT `robos_dueÃ±os_FK` FOREIGN KEY (`duenos_id`) REFERENCES `dueÃ±os` (`id`),
...
-- Dump completed on 2024-09-02 15:58:13
